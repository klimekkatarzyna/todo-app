	...
	return (
		<>
			<div onContextMenu={displayMenu}>
				<div
					className={`flex items-center relative h-[3.5rem] p-[0.9rem] cursor-pointer shadow-sm hover:bg-lightBlue active:bg-lightBlue border-solid border-b-[1px] border-border-500 `}
					key={index}
					draggable
